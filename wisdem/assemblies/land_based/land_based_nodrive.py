...
def Init_LandBasedAssembly(prob, blade, Nsection_Tow, Analysis_Level=0, fst_vt={}):
    ...
    prob['diameter'] = 77.0
    hub_diam = 3.0
    prob['bladeLength'] = 0.5 * (prob['diameter'] - hub_diam)
    prob['hubFraction'] = 0.5 * hub_diam / prob['bladeLength']
    ...
    prob['tower_section_height'] = (prob['hub_height'] - prob['foundation_height']) / Nsection_Tow * np.ones(
        Nsection_Tow)
