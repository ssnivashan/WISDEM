...
class PMSG_Arms_OM(ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
		...
		outputs['S'], outputs['Slot_aspect_ratio'], outputs['u_Ar'], outputs['y_Ar'], outputs['z_A_r'], 
		...
		outputs['Copper'], outputs['Iron'], outputs['Structural_mass'], outputs['Mass'], outputs['mass_PM'], outputs['cm'], outputs['I']) \
